...
#class ExcelEcoSystemSeekerView (seeker.SeekerView, wb_excel.ExcelEcoSystemWorkbook):
#    document = None
#    using = client
#    index = "excel"
#    page_size = 30
...
#class ExcelPatentsSeekerView (seeker.SeekerView, wb_excel.ExcelPatentsWorkbook):
#    document = None
#    using = client
#    index = "excel"
#    page_size = 30
...
#class ExcelIngrMoleculesSeekerView (seeker.SeekerView,  wb_excel.ExcelIngrMoleculesWorkbook):
#    document = None
#    using = client
#    index = "excel"
#    page_size = 30
