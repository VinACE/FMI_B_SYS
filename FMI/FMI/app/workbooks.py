...
class SurveyWorkbook:
    ...
    dashboard_panels = {
        "air_emotion_perc_col" : {
            'chart_type': "ColumnChart",
            'chart_title' : "Air Emotion %",
            'data_type'  : "aggr",
            'controls'    : ['CategoryFilter', 'tile_layout_select'],
            'listener'    : {'select' : {'colsort': None}},
            'X_facet'     : {
        ...
        "cand_air_emotion_top_table" : {
            'chart_type': "Table",
            'chart_title' : "Air Emotion Top-3",
            'data_type'  : "aggr",
            'controls'    : ['CategoryFilter'],
            'transpose'   : False,
            'listener'    : {'select' : {'rowsort': None}},
        ...
        "cleaners_emotion_perc_col" : {
            'chart_type': "ColumnChart",
            'chart_title' : "Cleaner Emotion %",
            'data_type'  : "aggr",
            'listener'    : {'select' : {'colsort': None}},
            'X_facet'     : {
                'field'   : "cleaners_emotion",
                'label'   : "Cleaner Emotion",
                'calc'    : 'percentile',
                "answers" : [],
                "values"  : ["Yes"],
                'total'   : False },
        ...
        "topline_liking_table" : {
            ...
            'controls'    : ['CategoryFilter', 'tile_layout_select'],
            'help'        : "Select Row for sorting, Select Column Header for filter",
            'listener'    : {'sort' : ["cand_air_emotion_radar", "cand_expected_benefits_radar", "cand_ideal_benefits_radar", "cand_olfactive_attr_radar"], 'select' : {'rowsort': None}},
            'X_facet'     : {
                'field'   : "liking.keyword",
                'label'   : "Hedonics_",
                'lines'   : {"liking.keyword" : {'0-Mean':['mean'], '1-Excellent':[7], '2-Top2':[7,6], '3-Bottom2':[2,1]}},
    ...
    storyboard_panels_onepager = [
        {'name'     : "panel_onepager",
         'layout'   : OrderedDict({'rows': [["topline_liking_table"], ["topline_strength_table"],
                                            ["cand_air_emotion_top_table", "cand_olfactive_attr_top_table"],
    ...
    storyboard_panels_profile = [
        {'name'     : "panel_profile_emotion",
         'layout'   : OrderedDict({'rows': [["topline_liking_table"], ["cand_air_emotion_radar"]]}),
        },
    ...
    storyboard_panels_qa = [
        {'name'     : "panel_qa_emotion",
         'layout'   : OrderedDict({'rows': [["air_emotion_perc_col", "cleaners_emotion_perc_col"]]}),
        },
        {'name'     : "panel_qa_benefits",
         'layout'   : OrderedDict({'rows': [["expected_benefits_perc_col", "ideal_benefits_perc_col"]]}),
        },
        {'name'     : "panel_qa_olfactive_attr",
         'layout'   : OrderedDict({'rows': [["olfactive_attr_perc_col", "industry_perc_col"]]}),
        },
        ]

    storyboard_panels_stats = [
        {'name'     : "panel_stats_emotion",
         'layout'   : OrderedDict({'rows': [["cand_air_emotion_table", "cand_air_emotion_top_table"]]}),
        },
    ...
    dashboard_panels_hedonics['rows'] = [["liking_perc_col", "intensity_perc_col"],
                                         ...
                                         ["topline_liking_table"]]
    dashboard_panels_qa = OrderedDict()
    dashboard_panels_qa['rows'] = [["air_emotion_perc_col", "cleaners_emotion_perc_col"],
                                      ["expected_benefits_perc_col", "ideal_benefits_perc_col"],
                                      ["olfactive_attr_perc_col", "industry_perc_col"]]
    dashboard_panels_stats = OrderedDict()
    dashboard_panels_stats['rows'] = [["ttest_table"]]
    dashboard_panels_profile = OrderedDict()
    dashboard_panels_profile['rows'] = [["topline_liking_table"], ["cand_air_emotion_radar", "cand_olfactive_attr_radar"]]
    ...
    workbooks = {
        ...
        "global panels" : {
            'display'       : ["gender", "age", 'brand', "blindcode", "freshness"],
            'facets'        : ["survey.keyword", "category.keyword", "country.keyword", "gender.keyword", "age.keyword", "brand.keyword", "product_form.keyword",
